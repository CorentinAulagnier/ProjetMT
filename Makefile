...
MODULES = Fresh Lambda_Calcul Option Tricks MyList MyString Pretty Bit_Vector Date Logger Color Html Pattern Symbol State Alphabet Band Action Transition Turing_Machine Configuration Execution LC_by_MT Emulator Demo $(SOL)
